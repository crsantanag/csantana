            ...
            <div className="flex" style={{backgroundColor: "white"}}>
                <div className="flex flex-col md:flex-row">
                    <div className="w-full md:w-1/2 px-20 text-lg opacity-80" >
                        ...
                        <br/>
                        <br/>
                        <strong><a href="#2" className="opacity-100 p-4 bg-black text-white px-4 py-2 font-bold rounded-xl tracking-wider text-start opacity-100" style={{width: "200px"}}>Continuar leyendo</a></strong>
                    </div>
